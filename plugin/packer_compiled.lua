...
_G.packer_plugins = {
  ["AutoSave.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/AutoSave.nvim",
    url = "https://github.com/Pocco81/AutoSave.nvim"
  },
  ["Comment.nvim"] = {
    after_files = { "/home/liuxin/.local/share/nvim/site/pack/packer/opt/Comment.nvim/after/plugin/Comment.lua" },
  ...
  ["aerial.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/aerial.nvim",
  ...
  ["bufdelete.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/bufdelete.nvim",
  ...
  ["bufferline.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/bufferline.nvim",
  ...
  catppuccin = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/catppuccin",
  ...
  ["cmp-nvim-lsp"] = {
    after = { "nvim-lsp-installer" },
    after_files = { "/home/liuxin/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lsp/after/plugin/cmp_nvim_lsp.lua" },
    load_after = {
      ["nvim-lspconfig"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/cmp-nvim-lsp",
  ...
  ["cmp-tabnine"] = {
    after_files = { "/home/liuxin/.local/share/nvim/site/pack/packer/opt/cmp-tabnine/after/plugin/cmp-tabnine.lua" },
    load_after = {
      ["nvim-cmp"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/cmp-tabnine",
    url = "https://github.com/tzachar/cmp-tabnine"
  },
  ["cmp-vsnip"] = {
    after_files = { "/home/liuxin/.local/share/nvim/site/pack/packer/opt/cmp-vsnip/after/plugin/cmp_vsnip.vim" },
    load_after = {
      ["nvim-cmp"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/cmp-vsnip",
    url = "https://github.com/hrsh7th/cmp-vsnip"
  },
  ["copilot.vim"] = {
    config = { "require('configure/plugins/copilot')" },
    loaded = true,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/start/copilot.vim",
  ...
  ["emmet-vim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/emmet-vim",
  ...
  fd = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/fd",
  ...
  ["fidget.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/fidget.nvim",
    url = "https://github.com/j-hui/fidget.nvim"
  },
  ["filetype.nvim"] = {
    loaded = true,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/start/filetype.nvim",
  ...
  ["impatient.nvim"] = {
    after = { "surround.nvim", "nvim-treesitter", "AutoSave.nvim", "nvim-lastplace", "nvim-hlslens", "venn.nvim", "nvim-web-devicons", "nvim-ts-context-commentstring", "neoformat", "undotree", "nvim-lspconfig", "vim-dadbod", "vimcdoc", "friendly-snippets", "spellsitter.nvim", "nvim-notify", "plenary.nvim", "vim-repeat", "lsp_signature.nvim", "vim-carbon-now-sh", "indent-blankline.nvim", "persisted.nvim", "nvim-autopairs", "vim-python-pep8-indent", "emmet-vim", "ripgrep", "toggleterm.nvim", "vim-startuptime", "vim-illuminate", "fd", "nvim-markdown-preview", "which-key.nvim", "lspkind-nvim", "translate.nvim", "nvim-ts-rainbow", "nvim-ts-autotag", "nvim-scrollbar", "vim-visual-multi", "nvim-colorizer.lua", "nvim-dap", "todo-comments.nvim", "switch.vim" },
    loaded = true,
    only_config = true
  },
  ...
  ["lsp_signature.nvim"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/lsp_signature.nvim",
  ...
  ["lspkind-nvim"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/lspkind-nvim",
  ...
  ["lspsaga.nvim"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/lspsaga.nvim",
  ...
  neoformat = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/neoformat",
  ...
  ["nvim-cmp"] = {
    after = { "cmp-vsnip", "vim-dadbod-completion", "cmp-cmdline", "cmp-buffer", "cmp-tabnine", "cmp-path" },
  ...
  ["nvim-colorizer.lua"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/nvim-colorizer.lua",
  ...
  ["nvim-hlslens"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/nvim-hlslens",
  ...
  ["nvim-lastplace"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/nvim-lastplace",
  ...
  ["nvim-lightbulb"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/nvim-lightbulb",
  ...
  ["nvim-lsp-installer"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/nvim-lsp-installer",
  ...
  ["nvim-lspconfig"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/nvim-lspconfig",
  ...
  ["nvim-markdown-preview"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/nvim-markdown-preview",
  ...
  ["nvim-neoclip.lua"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/nvim-neoclip.lua",
  ...
  ["nvim-notify"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/nvim-notify",
  ...
  ["nvim-scrollbar"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/nvim-scrollbar",
  ...
  ["nvim-spectre"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/nvim-spectre",
  ...
  ["nvim-treesitter"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/nvim-treesitter",
  ...
  ["nvim-ts-context-commentstring"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/nvim-ts-context-commentstring",
  ...
  ["nvim-ts-rainbow"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/nvim-ts-rainbow",
    url = "https://github.com/p00f/nvim-ts-rainbow"
  },
  ["nvim-web-devicons"] = {
    after = { "cmp-nvim-lsp", "aerial.nvim", "lualine.nvim", "nvim-tree.lua", "telescope.nvim", "bufferline.nvim" },
    load_after = {},
    loaded = true,
    needs_bufread = false,
  ...
  ["persisted.nvim"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/persisted.nvim",
    url = "https://github.com/olimorris/persisted.nvim"
  },
  ["plenary.nvim"] = {
    after = { "gitsigns.nvim", "nvim-spectre" },
    load_after = {},
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ripgrep = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/ripgrep",
  ...
  ["spellsitter.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/spellsitter.nvim",
  ...
  ["surround.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/surround.nvim",
  ...
  ["switch.vim"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/switch.vim",
  ...
  ["todo-comments.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/todo-comments.nvim",
  ...
  ["toggleterm.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/toggleterm.nvim",
  ...
  ["translate.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/translate.nvim",
  ...
  undotree = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/undotree",
  ...
  ["venn.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/venn.nvim",
  ...
  ["vim-carbon-now-sh"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/vim-carbon-now-sh",
  ...
  ["vim-dadbod"] = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/vim-dadbod",
    url = "https://github.com/tpope/vim-dadbod"
  },
  ["vim-dadbod-completion"] = {
    after_files = { "/home/liuxin/.local/share/nvim/site/pack/packer/opt/vim-dadbod-completion/after/plugin/vim_dadbod_completion.lua", "/home/liuxin/.local/share/nvim/site/pack/packer/opt/vim-dadbod-completion/after/plugin/vim_dadbod_completion.vim" },
    load_after = {
      ["nvim-cmp"] = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/vim-dadbod-completion",
  ...
  ["vim-dadbod-ui"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/vim-dadbod-ui",
  ...
  ["vim-illuminate"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/vim-illuminate",
  ...
  ["vim-python-pep8-indent"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/vim-python-pep8-indent",
  ...
  ["vim-repeat"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/vim-repeat",
  ...
  ["vim-startuptime"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/vim-startuptime",
  ...
  ["vim-visual-multi"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/vim-visual-multi",
  ...
  ["vim-vsnip"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/vim-vsnip",
  ...
  vimcdoc = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/liuxin/.local/share/nvim/site/pack/packer/opt/vimcdoc",
...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'surround.nvim', 'nvim-treesitter', 'nvim-lastplace', 'nvim-ts-context-commentstring', 'undotree', 'nvim-lspconfig', 'vimcdoc', 'spellsitter.nvim', 'plenary.nvim', 'vim-repeat', 'indent-blankline.nvim', 'ripgrep', 'vim-illuminate', 'fd', 'which-key.nvim', 'nvim-ts-rainbow', 'vim-visual-multi', 'todo-comments.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'surround.nvim', 'nvim-treesitter', 'nvim-lastplace', 'nvim-ts-context-commentstring', 'undotree', 'nvim-lspconfig', 'vimcdoc', 'spellsitter.nvim', 'plenary.nvim', 'vim-repeat', 'indent-blankline.nvim', 'ripgrep', 'vim-illuminate', 'fd', 'which-key.nvim', 'nvim-ts-rainbow', 'vim-visual-multi', 'todo-comments.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
